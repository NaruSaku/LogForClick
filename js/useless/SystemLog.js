...
var log = new Object({
    Operate: {
        getLogData: function (type) {
            var point = [[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Fatal',3,'what'],[1,2,'Error',3,'what'],[1,2,'Warn',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Error',3,'what'],[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Error',3,'what'],[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Fatal',3,'what'],[1,2,'Error',3,'what'],[1,2,'Warn',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Fatal',3,'what'],[1,2,'Error',3,'what'],[1,2,'Warn',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Fatal',3,'what'],[1,2,'Error',3,'what'],[1,2,'Warn',3,'what'],[1,2,'Error',3,'what'],
                [1,2,'Error',3,'fjlasdfjlasdfjlasdfjlasdfjlasdfjlasdfjlasdfjslafjlasdfjflksdfjsl']];
    ...
    View: {
        ...
        pie: function (point) {
            var options=$("#pie-chart option:selected");  // 获取select按钮的值
            var Count;      //  最终画扇形图的数组
            var titleText;
            var seriesName;
            ...
            if(options.val()=="Month") {
                ...
                for (var id = 0; id < dollar.length; id++) {   // 把月份都放在一个数组里
                    //var oldTime = (new Date(dollar[0])).getTime(); //得到毫秒数
                    var newTime = new Date(dollar[id][0]); //就得到普通的时间了
            ...
            if(options.val()=="Level"){
                ...
                var arr = Object.keys(levelCount);
                var levelPoint=[];

                for(var levelID=0;levelID<3;levelID++){
                    levelPoint.push([arr[levelID],levelCount[arr[levelID]]]);
                }
                Count = levelPoint;
                titleText = "Click网站不同错误运行日志占比";
                seriesName = "级别日志占比";
            }
